...
<div id="sidebar" style="background-color:#1919ff;"><a href="#" class="visible-phone"><i class="icon icon-home"></i>MENU</a>
  <ul>
    ...
    <li style="float: right; background-color: #1919ff;">
                  <a><b style="font-size: 15px; color: white;"><i class="icon icon-user" style="padding-right: 8px;"></i><?php echo $_SESSION['email']?></b></a>
                 ...
                 <li style="float: right; background-color: #1919ff;">
                    <form action="logindashboard.php" method="POST" role="form">
                        <button type="submit" name="logout" class="btn-big" style="background-color:#1919ff; color: white; border:2px solid #1919ff; font-weight: bold; font-size: 15px;">Logout</button>                    
                    </form>
                </li>
     ...
     <div class="span8">
        <div class="widget-box">
          ...
          <div class="widget-content">
                    <center>
                                    <p style="color:#024fa4; font-size: 26px;">Welcome to Leapcoin Token!</p><br/>
    ...
    <div class="modal_view1">
      <div class="container">
          ...
          <div class="row">
             ...
             <div class="span6" style="margin-top: -240px;">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding fix_hgt" style="height: 330px;">
                      <ul class="recent-posts">
                          ...
                          <form action="logindashboard.php" method="POST">  
                            <div class="control-group" style="margin-left: 20px;">
                              <div class="controls">
                                <label style="font-size: 15px;">
                                  <input type="checkbox" name="radio1" />      
                                     I certify that I have checked my local, federal and other applicable laws thoroughly.</label>
                                <label style="font-size: 15px;">
                                  <input type="checkbox" name="radio2" />                       
                                    I understand that I must carefully review the Private Placement Memorandum once it is made available. I understand that it lists some of the risks involved in investing in LPC’s Token, Inc.</label>
                ...
                <?php
                  if(isset($_POST['submit1'])){
                    ...
                    if(!empty($radio1) && !empty($radio2) && !empty($radio3)){
                        header("Location:noninvestor.php");
                    }else{
                        echo "<script>alert('All button are required')</script>";
                    }
                  }
                ?>
          </div>
...
<div class="row-fluid" style="background-color: white;">
      <div id="footer" class="span12"> <p style="font-size: 16px;" >Copyright © Leapcoin Token 2018</p>
 </div>
    </div>
